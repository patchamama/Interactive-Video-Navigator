...
- Desplegar estos scripts en Github Deploy para no necesitar servidor local. 
 ...
 https://claude.ai/chat/9f1c7397-7498-4acc-bc44-404584747166
...
> Probar ocultar el texto ((Wating ready)) y quizás buscar una palabra que exista en alemán, inglés, frances y español para propiciar que se hagan cambios. A la hora de buscar la próxima línea pendiente, usar un algoritmo que agilice la búsqueda tratando de marcar la última línea encontrada y a partir de esta buscar la próxima y así que no se inicie siempre desde el principio. 
